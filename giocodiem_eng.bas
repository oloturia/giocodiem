  ...
  12 PRINT "When you get the '*' the track changes colour, you hit only the track of your current colour."
  13 PRINT "In the other game you have to avoid the stars (+)."
  20 PRINT INK 2;"Press a key to play!!!"
  21 PAUSE 0
...
1059 GO TO 235
1060 PRINT AT 0,0;"game over, score "+STR$ (score): BEEP 0.1,-20
1070 PRINT "play again?(y/n)"
1080 PAUSE 0
1090 IF INKEY$="y" THEN GO TO 22
...
2240 GO TO 2076
2250 PRINT AT 0,0;"game over, score "+STR$ (score)
2255 PRINT "play again?(y/n)"
2260 BEEP 0.1,-20
2270 LET a$=INKEY$
2280 IF a$="y" THEN GO TO 2000
